    ...
    public partial class frm_timeadding : Form
    {
        ...
        private void btn_confirm_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    this.dataGridView2.Columns["TimeStart"].Visible = false;
        ...
        private void btn_save_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (i == 0)
                {
                    ...
                    cmd1.CommandText = "insert into timeadd_db values ('" + txt_racername.Text + "','" + txt_plate.Text + "','" + txttime.Text + "','" + cmb_stage.Text + "','" + cmb_category.Text + "','" + cmb_event.Text + "','" + txt_date.Text + "')";
        ...
        private void btn_search_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    SqlCommand cmd = con.CreateCommand();
                    cmd.CommandType = CommandType.Text;
                    cmd.CommandText = "select * from racerandevent_db where RacePlateNo like '" + txt_search.Text + "%' AND EventAttended ='" + cmb_event.Text + "' and  Stage ='" + cmb_stage.Text + "' and  Category ='" + cmb_category.Text + "'ORDER BY id  DESC";
                    cmd.ExecuteNonQuery();
                    DataTable dt = new DataTable();
                    SqlDataAdapter da = new SqlDataAdapter(cmd);
                    da.Fill(dt);
        ...
        private void btn_update_Click(object sender, EventArgs e)
        {
            ...
            else if (MessageBox.Show("Are you sure you want to update this data?", "Update", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                ...
                SqlCommand cmd = con.CreateCommand();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "update timeadd_db set Time = '" + txttime.Text + "' where id='" + i + "'";
                cmd.ExecuteNonQuery();
